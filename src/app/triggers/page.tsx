    ...
    private void configureBindings() {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <ConceptBox
            ...
            code={<code>controller.a()<br/>&nbsp;&nbsp;.whileTrue(command);</code>}
          >
          ...
          <ConceptBox
            ...
            code={<code>new Trigger(<br/>&nbsp;&nbsp;() =&gt; sensor.get());</code>}
          >
            Triggers can also be created from sensor readings or custom conditions, not just controller buttons.
          </ConceptBox>

          <ConceptBox
            title="🔄 Trigger Composition"
            code={<code>trigger1.and(trigger2)<br/>&nbsp;&nbsp;.onTrue(command);</code>}
          >
            Combine multiple triggers using and(), or(), negate() to create complex activation conditions.
          </ConceptBox>
        </div>
      </section>
        ...
        <ContentCard>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-red-50 dark:bg-red-950/20 rounded-lg p-4 border border-red-200 dark:border-red-800">
              <h4 className="text-lg font-bold text-red-800 dark:text-red-300 mb-3">📋 Before</h4>
            ...
            <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
              <h4 className="text-lg font-bold text-green-800 dark:text-green-300 mb-3">✅ After</h4>
          ...
          <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-3">🎯 Final Implementation & GitHub Changes</h4>
          <GithubPageWithPR
      ...
      <section className="flex flex-col gap-8">
        <ContentCard>
          ...
          <div className="mt-4 space-y-8">
            <div>
              <h3 className="text-xl font-bold text-[var(--foreground)] mb-2">Extending WPILib Command</h3>
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                For more complex commands, extend Command directly instead of using inline methods. 
                <a 
