...
export default function AlphaStatusNote() {
  return (
    ...
    >
      ...
      Commands v3 + OpModes (GradleRIO <code>2027.0.0-alpha-7</code>, Phoenix 6{" "}
      <code>26.70.0-alpha-2</code>) on <strong>Java 25</strong> and{" "}
      <strong>SystemCore</strong>: so exact APIs may still shift between alpha
      builds. This page was last verified against alpha-7 in September 2026.
    </Box>
  );
}
