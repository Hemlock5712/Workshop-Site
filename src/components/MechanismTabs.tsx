    ...
    <section className="flex flex-col gap-8">
      ...
      <Tabs.Root defaultValue="arm" className="card">
        <Tabs.List className="flex border-b border-[var(--rule)]">
          <Tabs.Trigger
            value="arm"
            className="px-6 py-3 text-sm font-medium border-b-2 border-transparent text-[var(--tx2)] hover:text-[var(--tx)] data-[state=active]:border-[var(--accent)] data-[state=active]:text-[var(--tx2)] transition-colors"
          >
            Arm Mechanism
          </Tabs.Trigger>
          <Tabs.Trigger
